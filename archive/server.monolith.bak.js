...
// Seed del usuario admin por defecto (idempotente).
// El esquema completo vive en schema.sql y se ejecuta una sola vez al primer arranque de Postgres.
(async () => {
    try {
        const bcrypt = require('bcryptjs');
        ...
        console.error("⚠️ Error en inicialización:", e.message);
    }
})();
