const { defects } = require('../repositories');
...
exports.list = async (req, res) => {
    ...
    const rows = await defects.listByProject(project_id);
...
exports.create = async (req, res) => {
    ...
    const jira_epic_key = await defects.findEpicKeyByExecution(execution_id) || '';

    const defect_id = await defects.create({
