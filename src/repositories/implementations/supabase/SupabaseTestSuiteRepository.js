...
class SupabaseTestSuiteRepository extends TestSuiteRepository {
    constructor({ base } = {}) {
        super();
...
class SupabaseTestCaseRepository extends TestCaseRepository {
    constructor({ base } = {}) {
        super();
        this._base = base || new SupabaseBaseRepository({ client: undefined });
    }
...
class SupabaseTestRunRepository extends TestRunRepository {
    constructor({ base } = {}) {
        super();
        this._base = base || new SupabaseBaseRepository({ client: undefined });
    }
...
class SupabaseExecutionRepository extends ExecutionRepository {
    constructor({ base } = {}) {
        super();
        this._base = base || new SupabaseBaseRepository({ client: undefined });
    }
...
module.exports = {
    SupabaseTestSuiteRepository,
    SupabaseTestCaseRepository,
    SupabaseTestRunRepository,
