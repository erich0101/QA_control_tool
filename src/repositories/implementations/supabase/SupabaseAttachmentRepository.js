...
class SupabaseAttachmentRepository extends AttachmentRepository {
    constructor({ base } = {}) {
        super();
...
class SupabaseDefectRepository extends DefectRepository {
    constructor({ base } = {}) {
        super();
        this._base = base || new SupabaseBaseRepository({ client: undefined });
    }
...
class SupabasePreconditionRepository extends PreconditionRepository {
    constructor({ base } = {}) {
        super();
        this._base = base || new SupabaseBaseRepository({ client: undefined });
        this.tcPreconditions = new SupabaseTcPreconditionsRepository({ base: this._base });
    }
    _query(sql, params) { return this._base._query(sql, params); }
...
class SupabaseTcPreconditionsRepository extends TcPreconditionsRepository {
    constructor({ base } = {}) {
        super();
        this._base = base || new SupabaseBaseRepository({ client: undefined });
    }
...
class SupabaseProjectSequenceRepository extends ProjectSequenceRepository {
    constructor({ base } = {}) {
        super();
        this._base = base || new SupabaseBaseRepository({ client: undefined });
    }
...
class SupabaseJiraConfigsRepository extends JiraConfigsRepository {
    constructor({ base } = {}) {
        super();
        this._base = base || new SupabaseBaseRepository({ client: undefined });
    }
...
class SupabaseJiraUserConfigsRepository extends JiraUserConfigsRepository {
    constructor({ base } = {}) {
        super();
        this._base = base || new SupabaseBaseRepository({ client: undefined });
    }
...
module.exports = {
    ...
    SupabaseDefectRepository,
    SupabasePreconditionRepository,
    SupabaseTcPreconditionsRepository,
    SupabaseProjectSequenceRepository,
    SupabaseJiraConfigsRepository,
    SupabaseJiraUserConfigsRepository,
};
