...
class PostgresUserStoryRepository extends UserStoryRepository {
    constructor({ base } = {}) {
        super();
...
class PostgresScenarioRepository extends ScenarioRepository {
    constructor({ base } = {}) {
        super();
        this._base = base || new PostgresBaseRepository();
    }
...
class PostgresInconsistenciaRepository extends InconsistenciaRepository {
    constructor({ base } = {}) {
        super();
        this._base = base || new PostgresBaseRepository();
    }
...
module.exports = {
    PostgresUserStoryRepository,
    PostgresScenarioRepository,
    PostgresInconsistenciaRepository,
};
