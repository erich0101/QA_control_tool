...
class PostgresUserRepository extends UserRepository {
    constructor({ base } = {}) {
        ...
        this.permissions = new PostgresUserPermissionsRepository({ base: this._base });
        this.projectUsers = new PostgresProjectUsersRepository({ base: this._base });
    }
...
class PostgresUserPermissionsRepository extends UserPermissionsRepository {
    constructor({ base } = {}) {
        super();
        this._base = base || new PostgresBaseRepository();
    }
...
class PostgresProjectUsersRepository extends ProjectUsersRepository {
    constructor({ base } = {}) {
        super();
        this._base = base || new PostgresBaseRepository();
    }
...
module.exports = {
    ...
    PostgresUserPermissionsRepository,
    PostgresProjectUsersRepository,
};
